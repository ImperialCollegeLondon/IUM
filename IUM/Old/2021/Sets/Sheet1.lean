...
example : ∀ x : X, x ∈ A → x ∈ A := by sorry

example : ∀ x : X, x ∈ A ∧ x ∈ B → x ∈ A := by sorry
...
example : (∀ x, x ∈ A ∧ x ∈ B) → ∀ x, x ∈ A := by sorry

example : (∀ x, x ∈ A ∧ x ∈ B) → ∀ y, y ∈ B ∧ y ∈ A := by sorry

example : (∀ x, x ∈ A → x ∈ B) → (∀ y, y ∈ B → y ∈ C) → ∀ z, z ∈ A → z ∈ C := by sorry
