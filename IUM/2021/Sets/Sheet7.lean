...
example : x ∈ A ∩ B ∩ C ↔ x ∈ B ∩ C ∩ A := by sorry

example : A ∪ B ∪ C ∪ D = A ∪ (B ∪ (C ∪ D)) := by sorry

example : A ∪ B = C ∩ D → B ∪ A ∪ E = E ∪ C ∩ D := by sorry
...
-/
example : (A ∪ B) ∩ (C ∪ D) = A ∩ C ∪ B ∩ C ∪ A ∩ D ∪ B ∩ D := by sorry
